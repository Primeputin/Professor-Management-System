...
<html>
    ...
    <body>
        <h1>Rankings of professors in a subject by Approachability</h1>
        ...
        <%
            ...
            String attributeType = "approachability";
        ...
        <% 
            for (int i=0; i < rank.professor_idList.size(); i++) { %>
                Professor ID: <%=rank.professor_idList.get(i)%>  Approachability Average Rate: <%=rank.approachabilityAvgList.get(i)%><br>
