...
<html>
    ...
    <body>
        <h1>Rankings of professors in a subject by Explanation</h1>
        ...
        <%
            ...
            String attributeType = "explanation";
        ...
        <% 
            for (int i=0; i < rank.professor_idList.size(); i++) { %>
                Professor ID: <%=rank.professor_idList.get(i)%>  Explanation Average Rate: <%=rank.explanationAvgList.get(i)%><br>
